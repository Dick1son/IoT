...
//.....        
        ...
        */
	    ...
	    char* on1 = strstr(buffer, "/on1");
	    char* on2 = strstr(buffer, "/on2");
	    char* off1 = strstr(buffer, "/off1");
	    char* off2 = strstr(buffer, "/off2");

	    if (on1){
		printf("LED 1 SWITCH ON\n");
	    }
	    if (on2){
		printf("LED 2 SWITCH ON\n");
	    }
	    if (off1){
		printf("LED 1 SWITCH OFF\n");
	    }
   	    if (off2){
		printf("LED 2 SWITCH OFF\n");
	    }
